...
label end1:
    ...
    white "會遇到元稹，但這時他也不會有過往情事可以向元稹說嘴，元稹也做不出{color=#FF0000}會真詩三十韻{/color}。"
    white "也許是因為張生的內秉堅孤，他在最後臨死前喃喃著「餘真好色者，而適不我值。」"
    scene gameover1
    " "
...
label story1:
    ...
    show char3 at right
    white "便去附近的河邊洗漱，你在離開寺廟前看見了外邊曬著女子衣物，但那時並沒有多想。"
    hide char3
    hide clothes under the sun
    show char3 at left, slightly_higher
    show char5 at right, slightly_higher
    white "回來早膳，你食完素齋後向這裡的僧侶一問，才得知{color=#FF0000}「有崔氏孀婦，將歸長安，路出於蒲，亦止茲寺」{/color}。"
    hide char3
    hide char5
    hide bg1
    show bg6
    ...
    hide bg6
    white "到了晚上將睡時，你聽聞隔壁房中有兩位女性的談話聲，一者稍老，一者為幼。"
    menu:
        "這時你心想......"
        "「明天去認識看看，究竟是何許人也」":
            jump story2
...
label story2:
    ...
    hide bg1
    hide char3
    white "明日一早，張生已洗漱完畢回去寺中，恰好見到了崔氏遺孀，乃是她甫用膳完畢，正要走進廂房。"
    scene bg2
    hide bg3
    ...
    zf "公子你好，沒想到寺中還有其他人宿著，我們是要去長安的，暫住於此。"
    hide char4_1
    hide char3
    ...
    hide bg2
    " "
    white "是歲，鎮守蒲州的將領渾瑊甫亡，宦官丁文雅不善用兵，故軍不領旨，四處趁喪而亂，奪蒲州百姓之金銀。"
    white "而當時蒲州有名的大家崔家，財產甚厚，又有諸多奴僕，雖暫居於普救寺，但覺惶恐不安，不知所措。"
    show bg8 
    hide bg7
    " "
    menu:
...
label end2:
    hide char3
    hide char4
    white "崔氏被兵所擾，直至家道中落，後張生入京趕考，結識元稹，但崔家一事聽其母親說過，尤為遺憾。"
    scene gameover2
    " "
    show gameover2
...
label story3:
    scene bg10
    hide bg8
    white "過了十多天後，廉使杜確奉天子之命，來主持戎節，重新下令軍隊，平定軍亂。"
    show bg4
    show bg9
    hide bg10
    show char3 at left, slightly_higher
    ...
    hide char4
    zf "我只是個未亡人，帶著幼兒們，卻不幸遇上了兵亂，自己都難以保身，我還有那些尚還年幼的兒女們，而正因為你讓他們都活了下來，這豈是平凡的恩情所能比擬的？今天我就讓他們以仁兄之禮拜見，冀以報您的恩情！"
    show char4 at right, slightly_higher
    hide char4_2
    ...
    hide char4
    show bg12
    white "接著又喊她的女兒出來，說：「快點兒出來拜見妳的兄長，兄長對妳可是有救命之恩。」"
    show bg13
    hide bg12
    ...
    zf "是張兄救妳的命，不然妳早被擄去做壓寨夫人了，哪還能像現在用病推辭呢？"
    show bg11
    " "
    white "過了一段時間後，一位女子方出閨，穿著一身常服，面容姣好，沒有用新妝粉飾。香鬟垂落於眉旁，臉上銷紅沉韻，面上未抹脂粉，卻若光輝動人。"
    white "張生頓時感到驚訝，急忙對她行禮，女子則坐於鄭婦旁。"
    white "由於是鄭婦強迫著她出來的，斜視凝望著門戶，看起來內心有些怨懟，心思也不在此處。"
    menu:
        "「初次見面，不知姑娘芳齡？」":
            zf "天子甲子歲之七月，到了現在貞元庚辰年，如今她已經十七有餘了！"
        "「我可以娶妳嗎？」":
            zf "公子你要先納個採、問個名，我會考慮一下的。"
        "「妳就是崔鶯鶯嗎？我是來自2025年的穿越者，我是妳的大粉絲，可以跟妳要個簽名嗎？」":
            zf "大粉絲是什麼碗糕嗎？2025年是什麼？我記得現在不是貞元庚辰年嗎？"
    white "目前0.1劇情先到這裡 by梁倡瑋，0.2修改了一點版面"
